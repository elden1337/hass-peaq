...
class PeaqMoneySensor(SensorBase, RestoreEntity):
    ...
    async def async_added_to_hass(self):
        ...
        if state:
            ff = [0.633, 1.128, 0.334, 0.646, 0.909, 1.637, 2.085, 2.093, 1.385, 1.849, 1.803, 1.805, 1.634, 1.302, 1.079, 0.58, 0.815, 0.813, 1.219, 1.145, 0.417, 0.426, 0.736, 1.138, 1.04, 0.647, 0.519, 0.599, 0.433, 0.727, 0.9]
            await self.hub.nordpool.import_average_data(ff)
