...
class HubSensors(HubSensorsBase):
    ...
    async def async_setup(
            self, options: HubOptions, state_machine, domain: str, chargerobject, observer: IObserver
    ):
        await self.async_setup_base(options, state_machine, domain, chargerobject, observer)
