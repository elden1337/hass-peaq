...
CAUTIONHOURNAMES = [
    CAUTIONHOURNAME_SUAVE,
    CAUTIONHOURNAME_INTERMEDIATE,
    CAUTIONHOURNAME_AGGRESSIVE
]

CAUTIONHOURMAP = {
    CAUTIONHOURNAME_SUAVE: CAUTIONHOURTYPE_SUAVE,
    CAUTIONHOURNAME_INTERMEDIATE: CAUTIONHOURTYPE_INTERMEDIATE,
    CAUTIONHOURNAME_AGGRESSIVE: CAUTIONHOURTYPE_AGGRESSIVE
}

CAUTIONHOURMAP_REV = {
    CAUTIONHOURTYPE_SUAVE: CAUTIONHOURNAME_SUAVE,
    CAUTIONHOURTYPE_INTERMEDIATE: CAUTIONHOURNAME_INTERMEDIATE,
    CAUTIONHOURTYPE_AGGRESSIVE: CAUTIONHOURNAME_AGGRESSIVE
}
