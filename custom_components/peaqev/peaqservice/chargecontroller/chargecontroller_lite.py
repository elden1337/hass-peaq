    ...
    def _get_status(self):
        ...
        if charger_state in self._hub.chargertype.charger.chargerstates[CHARGERSTATES.Done]:
            ...
            if self._hub.carpowersensor.value < 1 and time.time() - self.latest_charger_start > self.DONETIMEOUT:
                ...
                if (self._hub.totalhourlyenergy.value < self._hub.current_peak_dynamic) or free_charge is True:
            ...
            update_timer = True
            if self._hub.totalhourlyenergy.value > self._hub.current_peak_dynamic and free_charge is False:
                ret = CHARGERSTATES.Stop
            else:
                ret = CHARGERSTATES.Start
